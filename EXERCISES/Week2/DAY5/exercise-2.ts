...
findFavouriteFood('').then(console.log).catch(err=>console.log(err)) // Test rejection for not providing a name
findFavouriteFood('Megan').then(console.log).catch(err=>console.log(err) )// Test rejection for giving a name that doesn't exist
findFavouriteFood('Tim').then(console.log).catch(err=>console.log(err)) // Test rejection for missing food id
